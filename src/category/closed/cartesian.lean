...
import category.limits.shapes.binary_products
import category.limits.shapes.constructions.preserve_binary_products
import category.closed.monoidal
import category.monoidal.of_has_finite_products
import category.adjunction
import category.epi_mono
