...
@[to_additive finset.sum_eq_filter_sum_add_filter_not_sum]
lemma prod_eq_filter_prod_mul_filter_not_prod [decidable_eq α] [comm_monoid β]
...
-- TODO, in the next two lemmas, use prod_map instead?
