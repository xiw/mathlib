...
begin
  ...
  rw [polynomial.mem_support_iff, not_not] at h,
  rw h,
  apply dvd_zero,
end
...
begin
  ...
  { classical,
    ...
    ext,
    simp only [coeff_C_mul, and_iff_right_iff_imp, mem_support_iff, ne.def, finset.mem_filter,
...
begin
  ...
  refine congr (congr rfl _) _; ext; simp [h0]
end
      ...
      { rcases eq_C_mul_primitive p with ⟨cp, p1, rfl, p1_prim, p1_deg⟩,
        ...
        { have h := hi (p1 - C p1.leading_coeff * X ^ p1.nat_degree) q1 (nat.le_of_lt_succ _),
          { rw [q1_prim.content_eq_one, mul_one] at h,
            ...
            rw [sub_sub, add_comm, sub_add, sub_sub_cancel, mul_assoc, leading_coeff_mul,
        ...
        { have h := hi (q1 - C q1.leading_coeff * X ^ q1.nat_degree) p1 (nat.le_of_lt_succ _),
          { rw [p1_prim.content_eq_one, mul_one] at h,
            ...
            apply gcd_content_eq_of_dvd_sub,
            rw [sub_sub, add_comm, sub_add, mul_comm, sub_sub_cancel, mul_assoc, leading_coeff_mul,
                ring_hom.map_mul, mul_assoc],
            apply dvd_sub (dvd.intro _ rfl) (dvd.intro _ rfl) },
